...
echo ℹ️  This may take 10-15 seconds on first run
...
echo.
echo ℹ️  Both windows will open automatically
echo ℹ️  Keep both running while using the app
echo ℹ️  Close the windows to stop the servers
echo.
pause
